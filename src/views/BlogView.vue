    ...
    <section class="py-32">
      <div class="container flex flex-col items-center gap-16 lg:px-16">
        <div class="text-center">
          ...
          <p class="mb-8 text-muted-foreground md:text-base lg:max-w-2xl lg:text-lg">
          ...
          <Button variant="link" class="w-full sm:w-auto">
            Explore all posts
        ...
        <div class="grid gap-6 md:grid-cols-2 lg:grid-cols-3 lg:gap-8">
          <a
            ...
            :key="post.id"
            :href="post.href"
            class="flex flex-col text-clip rounded-xl border border-border"
          >
            <div>
              <img
                :src="post.image"
            ...
            <div class="px-6 py-8 md:px-8 md:py-10 lg:px-10 lg:py-12">
              ...
              <p class="mb-3 text-muted-foreground md:mb-4 lg:mb-6">{{post.summary}}</p>
